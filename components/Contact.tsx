...
export const Contact: React.FC = () => {
  ...
  return (
    <footer id="contact" className="relative bg-black pt-40 pb-12 overflow-hidden">
      {/* Glow Effect */}
      <div className="absolute top-[20%] left-1/2 -translate-x-1/2 w-full max-w-[800px] h-[500px] bg-accent/10 blur-[150px] rounded-full pointer-events-none" />
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-5xl mx-auto text-center mb-32">
          ...
          <p className="text-xl text-neutral-400 mb-12 max-w-xl mx-auto font-light font-sans">
            {t("contact.subtitle")}
          </p>
