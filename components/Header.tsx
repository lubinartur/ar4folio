  ...
  return (
    ...
    >
       ...
       <div className="flex items-center gap-4">
         <div className="flex items-center gap-2 h-[42px] px-4 bg-black/75 backdrop-blur-md rounded-full border border-white/10">
       ...
       <div className="flex items-center gap-6">
          ...
          <a
            ...
            className="hidden md:flex items-center gap-2 h-[42px] px-5 rounded-full bg-black/75 hover:bg-black/90 backdrop-blur-md border border-white/10 text-xs font-mono uppercase tracking-widest text-neutral-300 hover:text-white transition-colors cursor-none"
          >
            {t("header.cv")}
          </a>
          ...
          <div className="relative flex items-center cursor-none">
            <button
              className="flex items-center gap-2 h-[42px] px-4 rounded-full bg-black/75 hover:bg-black/90 backdrop-blur-md border border-white/10 text-xs font-mono uppercase tracking-widest text-neutral-300 hover:text-white transition-colors cursor-none"
          ...
          <button
            ...
            className="group relative h-[42px] w-[48px] sm:w-[130px] flex items-center justify-center sm:justify-between sm:pl-5 pr-1 bg-black/75 hover:bg-black/90 backdrop-blur-md border border-white/10 rounded-full transition-all cursor-none"
          >
