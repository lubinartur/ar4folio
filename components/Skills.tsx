...
const ChatGPTIcon: React.FC<{ className?: string }> = ({ className = "w-16 h-16" }) => (
  <svg className={className} viewBox="-0.17090198558635983 0.482230148717937 41.14235318283891 40.0339509076386" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
